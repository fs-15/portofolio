...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark shadow-sm" style="background-color: #000;">
    <div class="container">
      ...
      <a href="" class="navbar-brand"><img src="img/white-icon.png" width="60rem"></a>
...
data-aos-anchor-placement="top-center">
<div class="card">
<img src="assets/img/thumbs/3.png" class="card-img-top" alt="Project 1">
<div class="card-body">
<!-- <h5 class="card-title">Card title</h5> -->
<p class="card-text">
...
data-aos-anchor-placement="top-center">
<div class="card">
<img src="assets/img/thumbs/6.png" class="card-img-top" alt="Project 1">
<div class="card-body">
<!-- <h5 class="card-title">Card title</h5> -->
<p class="card-text">
Lorem ipsum, dolor sit amet consectetur adipisicing elit. At, nesciunt.
...
<p>
Created by <i class="bi bi-instagram"></i> <a href="https://www.instagram.com/syarifudin_fa/" class="text-white fw-bold">FS-15</a>
</p>
</footer>
